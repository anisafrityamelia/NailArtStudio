    ...
    >
      ...
      <div className="container-landing px-4 sm:px-6 lg:px-25">
        <div className="grid grid-cols-[minmax(320px,1fr)_minmax(320px,1.05fr)] items-center gap-[clamp(28px,4vw,52px)] max-[991px]:grid-cols-1 max-[991px]:gap-7">
          ...
          {/* MAP */}
          <div className="min-h-[270px] overflow-hidden rounded-3xl bg-[#f6f6f6] shadow-[0_10px_24px_rgba(0,0,0,0.22)] 
          ...
          max-md:items-center max-md:text-center">
            ...
            <div className="mb-[22px]">
              ...
              <div className="flex items-center justify-end gap-4 max-md:justify-center max-md:gap-3">
            ...
            <div className="flex flex-col items-end gap-5 max-md:items-center">
