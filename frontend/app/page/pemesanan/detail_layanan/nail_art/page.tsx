...
export default function DetailLayananNailArt() {
    const router = useRouter();

    const dataLayanan = {
        layanan: "Nail Art",
        deskripsi: "Ingin kuku tampil beda dan lebih stylish? Di ALIA OYE STUDIO, kamu bisa pilih berbagai desain nail art mulai dari yang simple, elegan, sampai yang bold dan unik sesuai kepribadian kamu. Setiap desain dikerjakan dengan teliti oleh nail artist berpengalaman, menggunakan bahan berkualitas agar hasilnya rapi dan tahan lama. Kamu juga bebas request custom design sesuai keinginan mulai dari inspirasi yang lagi tren sampai desain favorit kamu sendiri.",
        estimasiHarga: 80000,
        gambar1: "/galeri 1.jpeg",
        gambar2: "/galeri 6.jpeg",
        gambar3: "/galeri 9.jpeg",
        gambar4: "/galeri 8.jpeg",
        pesanUrl: "/page/pemesanan/pemesanan_layanan/nail_art",
    };
