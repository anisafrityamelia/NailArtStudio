        ...
        <table className="w-full border-collapse table-fixed text-[10px] sm:text-xs md:min-w-[820px] md:text-sm">
          <thead className="bg-[#dd98ad] text-[#7d344b]">
            <tr className="text-center">
              {/* Aksi Mobile */}
              <th className="w-[14%] border border-[#c88ca1] px-1 py-2 md:hidden">
                Aksi
              </th>

              <th className="w-[7%] border border-[#c88ca1] px-1 py-2 md:w-[5%] md:px-3">
                No
              </th>

              <th className="w-[16%] border border-[#c88ca1] px-1 py-2 md:w-[14%] md:px-3">
                Kode Pesanan
              </th>

              <th className="w-[18%] border border-[#c88ca1] px-1 py-2 md:w-[16%] md:px-3">
                Nama Pelanggan
              </th>
              ...
              <th className="w-[28%] border border-[#c88ca1] px-1 py-2 md:w-[24%] md:px-3">
                Ulasan
              </th>
              ...
              <th className="w-[17%] border border-[#c88ca1] px-1 py-2 md:w-[12%] md:px-3">
                Status
              </th>
          ...
          <tbody className="bg-white/70 font-medium text-[#7d344b]">
            {data.map((item, index) => (
              <tr key={item.id_ulasan}>
                  ...
                  <div className="flex justify-center">
                    {item.status_tampil === "ditampilkan" ? (
                      <button
                        ...
                        className="flex shrink-0 items-center gap-0.5 rounded bg-gradient-to-r from-[#E45082] to-[#7D344B] px-1 py-0.5 text-[8px] text-white shadow-soft-text"
                      >
                        <EyeOff size={11} />
                        Hide
                      </button>
                ...
                <td className="border border-[#e2b6c4] px-1 py-2 text-center align-top sm:px-3">
                  {index + 1}
                </td>
                ...
                <td className="hidden border border-[#e2b6c4] px-2 py-2 align-top break-words md:table-cell md:px-3">
                  {item.nama_layanan}
                </td>
                ...
                <td className="hidden border border-[#e2b6c4] px-2 py-2 text-center align-top md:table-cell md:px-3">
                  {item.rating}
                </td>

                <td className="hidden border border-[#e2b6c4] px-2 py-2 align-top md:table-cell md:px-3">
                ...
                <td className="border border-[#e2b6c4] px-0.5 py-2 text-center align-top md:px-3">
                  <span
                    className={`inline-flex items-center justify-center rounded-full px-1 py-0.5 text-[7px] leading-none font-semibold whitespace-nowrap sm:px-2 sm:py-1 sm:text-[11px] ${
                      item.status_tampil === "ditampilkan"
